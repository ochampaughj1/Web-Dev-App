...
const l1 = new Book(12, 2, "Legend", 200, "temp", 2000, "./assets/images/legend.jpg", "Marie Lu");
const l2 = new Book(13, 2, "Progidy", 200, "temp", 2000, "./assets/images/prodigy.jpg", "Marie Lu");
const l3 = new Book(14, 2, "Champion", 200, "temp", 2000, "./assets/images/champion.jpg", "Marie Lu");
const l4 = new Book(15, 2, "Rebel", 200, "temp", 2000, "./assets/images/rebel.jpg", "Marie Lu")

const BZRK = new Series(3, "BZRK", 3);
const b1 = new Book(16, 3, "BZRK", 200, "temp", 2000, "./assets/images/BZRK.jpg", "Michael Grant");
const b2 = new Book(17, 3, "BZRK: Reloaded", 200, "temp", 2000, "./assets/images/BZRK-Reloaded.jpg", "Michael Grant");
const b3 = new Book(18, 3, "BZRK: Apocalypse", 200, "temp", 2000, "./assets/images/BZRK-Apocalypse.jpg", "Michael Grant");
